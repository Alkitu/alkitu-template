...
export interface IPasswordManagementService extends IBaseService {
  ...
  ): Promise<ServiceResult<PasswordResetResult>>;
  ...
  validatePassword(
    password: string,
    userId?: string,
  ): Promise<ServiceResult<PasswordValidation>>;
  ...
  ): Promise<ServiceResult<PasswordPolicy>>;
  ...
  checkPasswordCompromise(
    password: string,
  ): Promise<ServiceResult<{ isCompromised: boolean; breachCount?: number }>>;
  ...
  validateResetToken(
    ...
    ServiceResult<{ isValid: boolean; userId?: string; expiresAt?: Date }>
  >;
  ...
  ): Promise<ServiceResult<{ password: string; strength: PasswordValidation }>>;
   ...
   */
  auditPasswordCompliance(): Promise<
    ServiceResult<{
      usersWithWeakPasswords: string[];
      usersNeedingPasswordChange: string[];
    }>
  >;
}
