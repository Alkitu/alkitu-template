...
export class ChatbotConfigController {
  ...
  @ApiOperation({
    ...
    description:
      'Create the initial chatbot configuration if none exists. Admin only.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Update existing chatbot configuration settings. Requires Admin or Employee role.',
  })
  @ApiBody({
  ...
  @ApiOperation({
    ...
    description:
      'Reset the chatbot configuration to default values. Admin only.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Get configuration formatted for widget preview (public-safe data only)',
  })
  @ApiResponse({
    status: 200,
