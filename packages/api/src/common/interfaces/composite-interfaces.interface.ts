 ...
 */
export interface ICompleteUserService
 ...
 */
export interface IUserManagementAndProfileService
  extends IUserManagementService,
    IUserProfileService {
  // Composite interface - no additional methods
}
 ...
 */
export interface ICompleteAuthService
 ...
 */
export interface IAuthAndPasswordService
  extends IAuthenticationService,
    IPasswordManagementService {
  // Composite interface - no additional methods
}
 ...
 * - Individual interfaces still available for specific needs
 */
export interface ICompleteEmailService
  extends IEmailSendingService,
 ...
 */
export interface IEmailSendingAndTemplatesService
  extends IEmailSendingService,
    IEmailTemplatesService {
  // Composite interface - no additional methods
}
 ...
 */
export interface IEmailTemplatesAndAnalyticsService
  extends IEmailTemplatesService,
    IEmailAnalyticsService {
  // Composite interface - no additional methods
}
 ...
 */
export interface IEmailSendingAndAnalyticsService
  extends IEmailSendingService,
    IEmailAnalyticsService {
  // Composite interface - no additional methods
}
...
export interface ServiceFactory {
  createUserService(
    components: Partial<UserServiceComponents>,
  ): ICompleteUserService;
  createAuthService(
    components: Partial<AuthServiceComponents>,
  ): ICompleteAuthService;
  createEmailService(
    components: Partial<EmailServiceComponents>,
