...
export class EmailController {
    ...
    switch (type) {
      ...
      case 'marketing':
        return {
          ...
          contentHtml:
            '<h1>Welcome to our newsletter!</h1><p>This is a test marketing email.</p>',
          unsubscribeUrl: baseUrls.unsubscribe,
          supportUrl: baseUrls.support,
  ...
  @ApiOperation({
    ...
    description:
      'Display information about registered email channels and supported types. Demonstrates OCP extensibility.',
  })
  @ApiResponse({
    status: 200,
