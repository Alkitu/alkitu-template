 ...
 */
export interface IEmailChannel<T extends IBaseEmailData = IBaseEmailData>
...
export interface IEmailRegistry extends IBaseService {
   ...
   */
  registerChannel<T extends IBaseEmailData>(
    channel: IEmailChannel<T>,
   ...
   */
  getChannel<T extends IBaseEmailData>(
    channelType: string,
  ): Promise<IEmailChannel<T> | null>;
   ...
   * - Must validate data before sending
   */
  sendEmail<T extends IBaseEmailData>(
    data: T,
