...
describe('UserFacadeService Simple Tests', () => {
  ...
  describe('anonymizeUser', () => {
    // TODO: Fix service implementation - anonymize values don't match expectations
    // Issue: Service passes different firstname/lastname values and missing fields
    // Tracking: ALI-115-FOLLOW-UP
    it.skip('should anonymize user successfully', async () => {
      // Arrange
      const userId = 'user-id';
      const user = {
        id: userId,
