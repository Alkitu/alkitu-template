...
export interface IRegistrationService extends IBaseService {
   ...
   */
  registerUser(registrationData: RegistrationData): Promise<ServiceResult<RegistrationResult>>;
   ...
   */
  verifyEmail(verificationToken: string): Promise<ServiceResult<EmailVerificationResult>>;
   ...
   */
  validateRegistrationData(registrationData: RegistrationData): Promise<ServiceResult<RegistrationValidation>>;
   ...
   */
  sendInvitation(invitationData: InvitationData): Promise<ServiceResult<Invitation>>;
   ...
   */
  acceptInvitation(invitationToken: string, registrationData: Omit<RegistrationData, 'email'>): Promise<ServiceResult<RegistrationResult>>;
   ...
   */
  getPendingInvitations(inviterId: string): Promise<ServiceResult<Invitation[]>>;
}