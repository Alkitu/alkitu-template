...
export interface IEmailAnalyticsService extends IBaseService {
  ...
  getCampaignAnalytics(
    ...
    startDate?: Date,
    endDate?: Date,
  ): Promise<ServiceResult<EmailCampaignAnalytics>>;
  ...
  getTemplateAnalytics(
    ...
    startDate?: Date,
    endDate?: Date,
  ): Promise<ServiceResult<EmailTemplateAnalytics>>;
  ...
  getEngagementTrends(
    ...
    startDate?: Date,
    endDate?: Date,
  ): Promise<ServiceResult<EmailEngagementTrends>>;
  ...
  getListAnalytics(
    ...
    startDate?: Date,
    endDate?: Date,
  ): Promise<ServiceResult<EmailListAnalytics>>;
  ...
  getTopPerformingCampaigns(
    metric: 'open_rate' | 'click_rate' | 'engagement_score',
    limit?: number,
    period?: { startDate: Date; endDate: Date },
  ): Promise<
    ServiceResult<
      Array<{ campaignId: string; campaignName: string; score: number }>
    >
  >;
   ...
   */
  getDeliverabilityInsights(period?: {
    startDate: Date;
    endDate: Date;
  }): Promise<
    ServiceResult<{
      deliveryRate: number;
      bounceAnalysis: Record<string, number>;
  ...
  ): Promise<ServiceResult<{ downloadUrl: string; expiresAt: Date }>>;
}
