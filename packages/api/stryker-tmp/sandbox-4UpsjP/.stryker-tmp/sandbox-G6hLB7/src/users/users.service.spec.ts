...
describe('UsersService', () => {
  ...
  describe('create', () => {
    ...
    it('should create a user successfully', async () => {
      ...
      PrismaServiceMock.user.findUnique.mockResolvedValue(null); // User doesn't exist
      mockedBcrypt.hash.mockResolvedValue(hashedPassword as never);
      PrismaServiceMock.user.create.mockResolvedValue(createdUser as any);
    ...
    it('should throw ConflictException if user already exists', async () => {
      PrismaServiceMock.user.findUnique.mockResolvedValue(mockUser as any);
  ...
  describe('bulkUpdateStatus', () => {
    it('should update the status of multiple users', async () => {
      ...
      PrismaServiceMock.user.findMany.mockResolvedValue(userIds.map(id => ({ id })) as any);
      PrismaServiceMock.user.updateMany.mockResolvedValue({ count: userIds.length } as any);
  ...
  describe('remove', () => {
    it('should delete a user successfully', async () => {
      PrismaServiceMock.user.findUnique.mockResolvedValue(mockUser as any);
      PrismaServiceMock.user.delete.mockResolvedValue(mockUser as any);
  ...
  describe('validateUser', () => {
    ...
    it('should validate user with correct credentials', async () => {
      ...
      PrismaServiceMock.user.update.mockResolvedValue(mockUser as any);
  ...
  describe('updateTags', () => {
    ...
    it('should update user tags successfully', async () => {
      ...
      PrismaServiceMock.user.findUnique.mockResolvedValue(mockUser as any);
      PrismaServiceMock.tag.findMany.mockResolvedValue(tagIds.map(id => ({ id })) as any);
      PrismaServiceMock.user.update.mockResolvedValue(userWithTags as any);
      ...
      expect(PrismaServiceMock.tag.findMany).toHaveBeenCalledWith({ where: { id: { in: tagIds } }, select: { id: true } });
      expect(PrismaServiceMock.user.update).toHaveBeenCalledWith({
        where: { id: userId },
        data: {
          tagIds: { set: tagIds },
    ...
    it('should throw BadRequestException if one or more tag IDs are invalid', async () => {
      PrismaServiceMock.user.findUnique.mockResolvedValue(mockUser as any);
      PrismaServiceMock.tag.findMany.mockResolvedValue([ { id: 'tag1' } ] as any); // Only one tag exists
  ...
  describe('changePassword', () => {
    ...
    it('should change user password successfully', async () => {
      PrismaServiceMock.user.findUnique.mockResolvedValue(userWithPassword as any);
      mockedBcrypt.compare.mockResolvedValue(true as never);
      mockedBcrypt.hash.mockResolvedValue(hashedPassword as never);
      PrismaServiceMock.user.update.mockResolvedValue({ ...userWithPassword, password: hashedPassword } as any);
  ...
  describe('markEmailAsVerified', () => {
    it('should mark email as verified', async () => {
      ...
      PrismaServiceMock.user.update.mockResolvedValue(verifiedUser as any);
