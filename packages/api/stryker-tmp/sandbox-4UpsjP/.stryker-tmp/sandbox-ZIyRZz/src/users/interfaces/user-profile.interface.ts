...
export interface IUserProfileService extends IBaseService {
   ...
   * - Profile-specific operation
   */
  updatePreferences(userId: string, preferences: Partial<ProfileData['preferences']>): Promise<ServiceResult<UserProfile>>;
   ...
   * - Profile-specific operation
   */
  updateSocialLinks(userId: string, socialLinks: Partial<ProfileData['socialLinks']>): Promise<ServiceResult<UserProfile>>;
   ...
   */
  validateProfileData(profileData: ProfileData): Promise<ServiceResult<{ isValid: boolean; errors: string[] }>>;
   ...
   */
  isProfileComplete(userId: string): Promise<ServiceResult<{ isComplete: boolean; missingFields: string[] }>>;
}