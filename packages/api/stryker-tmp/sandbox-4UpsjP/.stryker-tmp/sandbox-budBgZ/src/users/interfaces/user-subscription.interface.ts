...
export interface IUserSubscriptionService extends IBaseService {
   ...
   */
  pauseSubscription(userId: string, pauseUntil?: Date): Promise<ServiceResult<UserSubscription>>;
   ...
   */
  getSubscriptionUsage(userId: string): Promise<ServiceResult<SubscriptionUsage>>;
   ...
   */
  canPerformAction(userId: string, action: 'create_user' | 'upload_file' | 'api_call' | 'create_project'): Promise<ServiceResult<boolean>>;
   ...
   */
  getSubscriptionHistory(userId: string): Promise<ServiceResult<SubscriptionChange[]>>;
   ...
   */
  validateSubscriptionStatus(userId: string): Promise<ServiceResult<{ isValid: boolean; issues: string[] }>>;
   ...
   */
  getAvailablePlanChanges(userId: string): Promise<ServiceResult<{ upgrades: SubscriptionPlan[]; downgrades: SubscriptionPlan[] }>>;
}