...
export class UsersController {
  ...
  async updateTags(
    ...
    return this.usersService.updateTags(id, updateUserTagsDto);
  }
  ...
  async bulkDeleteUsers(@Body() bulkDeleteDto: BulkDeleteUsersDto) {
    return this.usersService.bulkDeleteUsers(bulkDeleteDto);
  }
  ...
  async bulkUpdateStatus(@Body() bulkUpdateStatusDto: BulkUpdateStatusDto) {
    return this.usersService.bulkUpdateStatus(bulkUpdateStatusDto);
  }
  ...
  async resetUserPassword(@Body() resetPasswordDto: ResetPasswordDto) {
    return this.usersService.resetUserPassword(resetPasswordDto);
  }
}
