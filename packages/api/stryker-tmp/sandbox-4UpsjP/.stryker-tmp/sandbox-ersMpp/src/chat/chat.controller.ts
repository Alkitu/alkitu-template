...
export class ChatController {
  ...
  @ApiOperation({
    ...
    description: 'Create a new chat conversation with optional initial message and contact information'
  })
  ...
  @ApiOperation({
    ...
    description: 'Retrieve conversations with optional filtering by status, priority, and search terms'
  })
  @ApiQuery({ name: 'status', required: false, description: 'Filter by conversation status' })
  @ApiQuery({ name: 'priority', required: false, description: 'Filter by conversation priority' })
  @ApiQuery({ name: 'search', required: false, description: 'Search in conversation content' })
  ...
  @ApiResponse({ status: 400, description: 'Bad Request - Invalid input data' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - Agent access required' })
  ...
  @ApiOperation({
    ...
    description: 'Change the status of a conversation (open, in_progress, resolved, etc.)'
  })
  @ApiParam({
    name: 'id',
    description: 'Conversation ID',
  ...
  @ApiOperation({
    ...
    description: 'Add an internal note to a conversation (not visible to visitors)'
  })
  @ApiParam({
    name: 'id',
    description: 'Conversation ID',
  ...
  @ApiOperation({
    ...
    description: 'Retrieve chat analytics including conversation stats and performance metrics'
  })
  @ApiQuery({
    name: 'days',
    required: false,
