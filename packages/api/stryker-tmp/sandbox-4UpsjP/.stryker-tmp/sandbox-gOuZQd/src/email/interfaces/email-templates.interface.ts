...
export interface IEmailTemplatesService extends IBaseService {
   ...
   */
  createTemplate(templateData: TemplateData): Promise<ServiceResult<EmailTemplate>>;
   ...
   */
  updateTemplate(templateId: string, templateData: Partial<TemplateData>): Promise<ServiceResult<EmailTemplate>>;
   ...
   */
  listTemplates(filters?: TemplateFilters, page?: number, limit?: number): Promise<ServiceResult<{ templates: EmailTemplate[]; total: number }>>;
   ...
   */
  renderTemplate(templateId: string, variables: Record<string, any>): Promise<ServiceResult<RenderedTemplate>>;
   ...
   */
  previewTemplate(templateId: string, sampleVariables?: Record<string, any>): Promise<ServiceResult<TemplatePreview>>;
   ...
   */
  validateTemplate(templateData: TemplateData): Promise<ServiceResult<TemplateValidation>>;
   ...
   */
  duplicateTemplate(templateId: string, newName: string): Promise<ServiceResult<EmailTemplate>>;
   ...
   */
  getTemplateVersions(templateId: string): Promise<ServiceResult<TemplateVersion[]>>;
   ...
   */
  restoreTemplateVersion(templateId: string, version: number): Promise<ServiceResult<EmailTemplate>>;
}