...
import { EmailChannelRegistryService } from '@/email/services/email-channel-registry.service';
...
describe('EmailController', () => {
  ...
  describe('testEmail', () => {
    ...
    it('should send verification email test successfully', async () => {
      ...
      expect(emailChannelRegistry.sendEmail).toHaveBeenCalledWith('verification', {
        userName: 'Test User',
        userEmail: 'test@example.com',
        verificationUrl:
    ...
    it('should send notification email test successfully', async () => {
      ...
      expect(emailChannelRegistry.sendEmail).toHaveBeenCalledWith('notification', 
        'test@example.com',
        'Test User',
