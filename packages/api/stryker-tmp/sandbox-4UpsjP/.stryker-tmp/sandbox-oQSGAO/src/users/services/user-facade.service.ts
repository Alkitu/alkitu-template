...
export class UserFacadeService {
  ...
  async update(id: string, updateUserDto: UpdateUserDto) {
    if (stryMutAct_9fa48("20")) {
      ...
      if (stryMutAct_9fa48("21") ? previousUser : (stryCov_9fa48("21"), !previousUser)) {
      ...
      if (stryMutAct_9fa48("28") ? fullUser || previousUser : (stryCov_9fa48("28"), fullUser && previousUser)) {
        if (stryMutAct_9fa48("29")) {
          {}
        } else {
          stryCov_9fa48("29");
          // Publish user updated event - convert UserResponse to User for events
          await this.userEvents.publishUserUpdated(fullUser, stryMutAct_9fa48("30") ? {} : (stryCov_9fa48("30"), {
            id: previousUser.id,
  ...
  async remove(id: string) {
    if (stryMutAct_9fa48("32")) {
      ...
      // Check if user exists
      if (stryMutAct_9fa48("33") ? user : (stryCov_9fa48("33"), !user)) {
      ...
      await this.userEvents.publishUserDeleted(id, stryMutAct_9fa48("38") ? {} : (stryCov_9fa48("38"), {
        id: user.id,
        email: user.email,
        name: user.name,
  ...
  async anonymizeUser(userId: string) {
    if (stryMutAct_9fa48("52")) {
      ...
      stryCov_9fa48("52");
      const anonymizedData = stryMutAct_9fa48("53") ? {} : (stryCov_9fa48("53"), {
        name: 'Anonymous User',
        lastName: 'Anonymous',
      ...
      if (fullUser) {
        if (stryMutAct_9fa48("59")) {
          ...
          stryCov_9fa48("59");
          await this.userEvents.publishUserUpdated(fullUser, stryMutAct_9fa48("60") ? {} : (stryCov_9fa48("60"), {
            id: userId
          }));
        }
      }
      return stryMutAct_9fa48("61") ? {} : (stryCov_9fa48("61"), {
        ...
        retainedFields: stryMutAct_9fa48("63") ? [] : (stryCov_9fa48("63"), ['id', 'role', 'createdAt']),
        timestamp: new Date()
      });
    }
  }
    ...
    if (stryMutAct_9fa48("67")) {
      ...
      try {
        if (stryMutAct_9fa48("68")) {
          ...
          stryCov_9fa48("68");
          await this.notificationService.createNotification(stryMutAct_9fa48("69") ? {} : (stryCov_9fa48("69"), {
            userId,
            message,
            type: 'info'
          }));
          return stryMutAct_9fa48("71") ? {} : (stryCov_9fa48("71"), {
            success: stryMutAct_9fa48("72") ? false : (stryCov_9fa48("72"), true),
  ...
  async createImpersonationToken(adminId: string, targetUserId: string) {
    if (stryMutAct_9fa48("79")) {
      ...
      return stryMutAct_9fa48("80") ? {} : (stryCov_9fa48("80"), {
        token,
        expiresAt: new Date(stryMutAct_9fa48("81") ? Date.now() - 3600000 : (stryCov_9fa48("81"), Date.now() + 3600000)),
        // 1 hour
        targetUserId,
        adminId,
        restrictions: stryMutAct_9fa48("82") ? [] : (stryCov_9fa48("82"), ['read-only', 'no-admin-actions'])
      });
    }
  }
  ...
  async bulkDeleteUsers(bulkDeleteDto: BulkDeleteUsersDto) {
    if (stryMutAct_9fa48("85")) {
        ...
        if (stryMutAct_9fa48("86")) {
          ...
          try {
            if (stryMutAct_9fa48("87")) {
              ...
              stryMutAct_9fa48("88") ? deletedCount-- : (stryCov_9fa48("88"), deletedCount++);
            }
          } catch (error) {
      ...
      await this.userEvents.publishUserBulkOperation('bulk_delete', userIds, stryMutAct_9fa48("92") ? {} : (stryCov_9fa48("92"), {
  ...
  async bulkUpdateRole(bulkUpdateRoleDto: BulkUpdateRoleDto) {
    if (stryMutAct_9fa48("96")) {
        ...
        if (stryMutAct_9fa48("97")) {
          ...
          try {
            if (stryMutAct_9fa48("98")) {
              ...
              stryCov_9fa48("98");
              await this.update(userId, stryMutAct_9fa48("99") ? {} : (stryCov_9fa48("99"), {
                role
              }));
              stryMutAct_9fa48("100") ? updatedCount-- : (stryCov_9fa48("100"), updatedCount++);
            }
          } catch (error) {
      ...
      // Publish bulk operation event
      await this.userEvents.publishUserBulkOperation('bulk_update_role', userIds, stryMutAct_9fa48("104") ? {} : (stryCov_9fa48("104"), {
        newRole: role,
        requestedCount: userIds.length,
  ...
  async bulkUpdateStatus(bulkUpdateStatusDto: BulkUpdateStatusDto) {
    if (stryMutAct_9fa48("108")) {
        ...
        if (stryMutAct_9fa48("109")) {
          ...
          try {
            if (stryMutAct_9fa48("110")) {
              ...
              stryCov_9fa48("110");
              await this.update(userId, stryMutAct_9fa48("111") ? {} : (stryCov_9fa48("111"), {
                status
              }));
              stryMutAct_9fa48("112") ? updatedCount-- : (stryCov_9fa48("112"), updatedCount++);
            }
          } catch (error) {
      ...
      // Publish bulk operation event
      await this.userEvents.publishUserBulkOperation('bulk_update_status', userIds, stryMutAct_9fa48("116") ? {} : (stryCov_9fa48("116"), {
        newStatus: status,
        requestedCount: userIds.length,
        successCount: updatedCount
      }));
      return stryMutAct_9fa48("117") ? {} : (stryCov_9fa48("117"), {
        success: stryMutAct_9fa48("118") ? false : (stryCov_9fa48("118"), true),
  ...
  async resetUserPassword(resetPasswordDto: ResetPasswordDto) {
    if (stryMutAct_9fa48("120")) {
      ...
      const {
        userId,
        sendEmail = stryMutAct_9fa48("121") ? false : (stryCov_9fa48("121"), true)
      } = resetPasswordDto;

      // Generate temporary password
      const tempPassword = stryMutAct_9fa48("122") ? Math.random().toString(36) : (stryCov_9fa48("122"), Math.random().toString(36).slice(stryMutAct_9fa48("123") ? +8 : (stryCov_9fa48("123"), -8)));
      ...
      // Publish password changed event
      await this.userEvents.publishUserPasswordChanged(userId);
      let emailSent = stryMutAct_9fa48("124") ? true : (stryCov_9fa48("124"), false);
      if (sendEmail) {
        if (stryMutAct_9fa48("127")) {
          ...
          try {
            if (stryMutAct_9fa48("128")) {
              ...
              stryCov_9fa48("128");
              await this.notificationService.createNotification(stryMutAct_9fa48("129") ? {} : (stryCov_9fa48("129"), {
                userId,
                message: `Your password has been reset. Your temporary password is: ${tempPassword}`,
                type: 'warning'
              }));
              emailSent = stryMutAct_9fa48("132") ? false : (stryCov_9fa48("132"), true);
            }
          } catch (error) {
      ...
      return stryMutAct_9fa48("135") ? {} : (stryCov_9fa48("135"), {
        success: stryMutAct_9fa48("136") ? false : (stryCov_9fa48("136"), true),
