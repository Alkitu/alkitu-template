...
describe('UserFacadeService - Comprehensive Mutation Tests', () => {
  ...
  // Helper function to create a complete User object for mocks
  ...
  const createNotificationResponse = (overrides: any = {}) => ({
    id: 'notif-1',
    createdAt: new Date(),
    updatedAt: new Date(),
    userId: '1',
  ...
  describe('findByEmail - Comprehensive Tests', () => {
    it('should call userRepository.findByEmail with correct email', async () => {
      ...
      const expectedUser = createFullUser({
        email: 'test@example.com',
        name: 'Test',
        lastName: 'User',
        contactNumber: '+1234567890',
  ...
  describe('bulkUpdateRole - Comprehensive Tests', () => {
    it('should update all user roles successfully', async () => {
      ...
      const updatedUser1 = { ...mockUser1, role: UserRole.ADMIN };
      const updatedUser2 = { ...mockUser2, role: UserRole.ADMIN };
  ...
  describe('bulkUpdateStatus - Comprehensive Tests', () => {
    it('should update all user statuses successfully', async () => {
      ...
      const updatedUser1 = { ...mockUser1, status: UserStatus.ACTIVE };
      const updatedUser2 = { ...mockUser2, status: UserStatus.ACTIVE };
