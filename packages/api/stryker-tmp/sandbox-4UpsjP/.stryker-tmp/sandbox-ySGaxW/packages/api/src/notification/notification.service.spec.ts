...
describe('NotificationService', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [NotificationService, mockPrismaService()],
    }).compile();
  ...
  describe('createNotification', () => {
    it('should create a notification successfully', async () => {
      ...
      prismaServiceMock.notification.create.mockResolvedValue(mockNotification);
  ...
  describe('getNotificationsWithFilters', () => {
    it('should get notifications with search filter', async () => {
      ...
      prismaServiceMock.notification.count.mockResolvedValue(1);
    ...
    it('should get notifications with pagination', async () => {
      ...
      prismaServiceMock.notification.count.mockResolvedValue(10);
  ...
  describe('markAsRead', () => {
    it('should mark notification as read', async () => {
      ...
      prismaServiceMock.notification.update.mockResolvedValue(mockNotification);
  ...
  describe('getUnreadCount', () => {
    it('should get unread count for user', async () => {
      ...
      prismaServiceMock.notification.count.mockResolvedValue(count);
    ...
    it('should return 0 when no unread notifications', async () => {
      ...
      prismaServiceMock.notification.count.mockResolvedValue(0);
  ...
  describe('Notification Preferences', () => {
    describe('getUserPreferences', () => {
      it('should get user preferences', async () => {
        ...
        prismaServiceMock.notificationPreference.findUnique.mockResolvedValue(
          mockPreferences,
        );
        ...
        expect(
          prismaServiceMock.notificationPreference.findUnique,
    ...
    describe('createOrUpdatePreferences', () => {
      it('should create or update user preferences', async () => {
        ...
        prismaServiceMock.notificationPreference.upsert.mockResolvedValue(
          mockResult,
        );
        ...
        expect(
          prismaServiceMock.notificationPreference.upsert,
        ).toHaveBeenCalledWith({
          where: { userId },
          create: {
            userId,
  ...
  describe('Bulk Operations', () => {
    ...
    describe('markAllAsRead', () => {
      it('should mark all unread notifications as read for a user', async () => {
        ...
        prismaServiceMock.notification.updateMany.mockResolvedValue(mockResult);

        const result = await service.markAllAsRead(userId);

        expect(prismaServiceMock.notification.updateMany).toHaveBeenCalledWith({
          where: { userId, read: false },
          data: { read: true },
        });
        expect(result).toEqual(mockResult);
    ...
    describe('deleteAllNotifications', () => {
      it('should delete all notifications for a user', async () => {
        ...
        prismaServiceMock.notification.deleteMany.mockResolvedValue(mockResult);

        const result = await service.deleteAllNotifications(userId);

        expect(prismaServiceMock.notification.deleteMany).toHaveBeenCalledWith({
          where: { userId },
        });
        expect(result).toEqual(mockResult);
      });
    ...
    describe('getNotificationStats', () => {
      it('should return notification statistics for a user', async () => {
        ...
        prismaServiceMock.notification.count
          .mockResolvedValueOnce(mockTotal)
          .mockResolvedValueOnce(mockUnread);
        prismaServiceMock.notification.groupBy.mockResolvedValue(mockByType);
