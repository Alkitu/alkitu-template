...
describe.skip('AuthService - SKIPPED: Has complex Prisma mock issues', () => {
  ...
  beforeEach(async () => {
    // Setup enhanced mocks for auth service
    setupMocksForService('AuthService');
