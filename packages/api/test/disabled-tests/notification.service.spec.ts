...
describe.skip('NotificationService - SKIPPED: Has complex Prisma mock issues', () => {
  ...
  describe('createNotification', () => {
    it('should create a notification successfully', async () => {
      ...
      PrismaServiceMock.useValue.notification.create.mockResolvedValue(
        mockNotification,
      );
      ...
      expect(
        PrismaServiceMock.useValue.notification.create,
  ...
  describe('getNotifications', () => {
    it('should get notifications for user', async () => {
      ...
      expect(
        PrismaServiceMock.useValue.notification.findMany,
      ).toHaveBeenCalledWith({
        where: { userId },
  ...
  describe('markAsRead', () => {
    it('should mark notification as read', async () => {
      ...
      PrismaServiceMock.useValue.notification.update.mockResolvedValue(
        mockNotification,
      );
      ...
      expect(
        PrismaServiceMock.useValue.notification.update,
      ).toHaveBeenCalledWith({
  ...
  describe('Bulk Operations', () => {
    ...
    describe('markAllAsRead', () => {
      it('should mark all unread notifications as read for a user', async () => {
        ...
        PrismaServiceMock.useValue.notification.updateMany.mockResolvedValue(
          mockResult,
        );
        ...
        expect(
          PrismaServiceMock.useValue.notification.updateMany,
        ).toHaveBeenCalledWith({
          where: { userId, read: false },
          data: { read: true },
        });
    ...
    describe('deleteAllNotifications', () => {
      it('should delete all notifications for a user', async () => {
        ...
        PrismaServiceMock.useValue.notification.deleteMany.mockResolvedValue(
          mockResult,
        );
        ...
        expect(
          PrismaServiceMock.useValue.notification.deleteMany,
        ).toHaveBeenCalledWith({
          where: { userId },
        });
        expect(result).toEqual(mockResult);
    ...
    describe('getNotificationStats', () => {
      it('should return notification statistics for a user', async () => {
        ...
        PrismaServiceMock.useValue.notification.groupBy.mockResolvedValue(
          mockByType,
        );
