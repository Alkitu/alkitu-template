...
describe.skip('UsersService - SKIPPED: Has complex Prisma mock issues', () => {
  ...
  describe('create', () => {
    ...
    it('should create a user successfully', async () => {
      ...
      PrismaServiceMock.useValue.user.create.mockResolvedValue(
        createdUser as any,
      );
  ...
  describe('bulkUpdateStatus', () => {
    it('should update the status of multiple users', async () => {
      ...
      PrismaServiceMock.useValue.user.findMany.mockResolvedValue(
        userIds.map((id) => ({ id })) as any,
      );
      PrismaServiceMock.useValue.user.updateMany.mockResolvedValue({
  ...
  describe('update', () => {
    ...
    it('should update a user successfully', async () => {
      ...
      PrismaServiceMock.useValue.user.update.mockResolvedValue(
        updatedUser as any,
      );
  ...
  describe('updateTags', () => {
    ...
    it('should update user tags successfully', async () => {
      const userWithTags = {
        ...mockUser,
        tagIds: tagIds,
        tags: tagIds.map((id) => ({ id, name: `Tag ${id}` })),
      };

      PrismaServiceMock.useValue.user.findUnique.mockResolvedValue(
        mockUser as any,
      );
      PrismaServiceMock.useValue.tag.findMany.mockResolvedValue(
        tagIds.map((id) => ({ id })) as any,
      );
      PrismaServiceMock.useValue.user.update.mockResolvedValue(
        userWithTags as any,
      );
      ...
      expect(PrismaServiceMock.useValue.tag.findMany).toHaveBeenCalledWith({
        where: { id: { in: tagIds } },
        select: { id: true },
      });
      expect(PrismaServiceMock.useValue.user.update).toHaveBeenCalledWith({
    ...
    it('should throw NotFoundException if user not found', async () => {
      ...
      await expect(
        service.updateTags(userId, updateUserTagsDto),
