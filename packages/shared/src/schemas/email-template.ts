/// ALI-121: Email Templates & Automation - Zod Validation Schemas

import { z } from 'zod';

// Enums
export const templateTriggerSchema = z.enum(['ON_REQUEST_CREATED', 'ON_STATUS_CHANGED'], {
...
}).strict(); // Prevent adding trigger or status fields
