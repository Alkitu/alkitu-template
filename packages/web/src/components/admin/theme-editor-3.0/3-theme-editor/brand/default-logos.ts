...
// Function to create default Alkitu icon logo
export function createDefaultAlkituIconLogo(primaryColor: string = '#2AB34B'): LogoVariant {
  ...
  // Create light and dark mode configurations
...
// Function to create default Alkitu horizontal logo
...
// Function to create default Alkitu vertical logo
