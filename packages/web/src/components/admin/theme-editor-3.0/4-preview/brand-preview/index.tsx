...
import { getCurrentModeVariants } from '../../3-theme-editor/brand/utils';
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {(Object.entries(getCurrentModeVariants(logo, isDarkMode)) as [string, string][]).map(([variantKey, svgContent]) => (
                      <div key={`${logo.id}-${variantKey}`} className="space-y-4">
                        ...
                        {/* LOGO_SHOWCASE */}
                        <div className={`rounded-2xl border border-border p-4 min-h-[120px] flex items-center justify-center ${VARIANT_BACKGROUNDS[variantKey as keyof typeof VARIANT_BACKGROUNDS]} relative overflow-hidden`}>
                          <div 
                        ...
                        <div className="space-y-2">
                          ...
                          {/* FULL_SIZE_SHOWCASE */}
                          <div className={`rounded border border-border p-3 flex items-center justify-center gap-3 flex-wrap ${VARIANT_BACKGROUNDS[variantKey as keyof typeof VARIANT_BACKGROUNDS]}`}>
