...
export function CheckboxRadiusModal({
  ...
  useEffect(() => {
    if (open) {
      ...
      const currentValue = getComputedStyle(root).getPropertyValue('--radius-checkbox').trim();
      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 gap-2">
              {RADIUS_PRESETS.map(preset => (
                <Button
                  key={preset.value}
                  variant={currentRadius === preset.value ? "default" : "outline"}
                  size="sm"
          ...
          <div className="text-sm text-muted-foreground text-center">
            Current radius: <span className="font-mono font-medium">
