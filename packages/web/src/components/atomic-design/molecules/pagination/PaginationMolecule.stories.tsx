...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Advanced pagination molecule with multiple variants, theme integration, and comprehensive features. Composes buttons and badges to create a complete pagination control.',
      },
    },
  },
  tags: ['autodocs'],
...
} satisfies Meta<typeof PaginationMolecule>;
