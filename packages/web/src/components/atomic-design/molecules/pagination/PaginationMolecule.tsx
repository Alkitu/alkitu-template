...
import type { PaginationMoleculeProps } from './PaginationMolecule.types';

/**
 * PaginationMolecule - Atomic Design Molecule
 *
 ...
 * ```
 */
export const PaginationMolecule = React.forwardRef<
  HTMLElement,
...
PaginationMolecule.displayName = 'PaginationMolecule';
