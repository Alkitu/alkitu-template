...
import { Button } from '@/components/atomic-design/atoms/buttons';
import { Input } from '@/components/atomic-design/atoms/inputs';
import { CustomIcon } from '@/components/atomic-design/atoms/custom-icon';
 ...
 * ```
 */
export const IconUploaderOrganism = React.forwardRef<HTMLDivElement, IconUploaderOrganismProps>(
  (
    {
      isOpen,
      onClose,
    ...
    const handleIconNameChange = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      <Dialog open={isOpen} onOpenChange={handleClose}>
        <DialogContent className="sm:max-w-[500px]" ref={ref}>
          ...
          <div className="space-y-4">
            ...
            {selectedFile && (
              <div className="space-y-2">
                <label className="text-sm font-medium" htmlFor="icon-name-input">
                  {iconNameLabel}
                </label>
                <Input
                  id="icon-name-input"
                ...
                />
                <p id="icon-name-helper" className="text-xs text-muted-foreground">
                  {iconNameHelper}
                </p>
              </div>
            )}
            ...
            {/* Error message */}
            {error && (
              <div className="flex items-center space-x-2 text-destructive text-sm" role="alert">
