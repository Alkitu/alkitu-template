...
export const useToast = () => {
  ...
  if (!context) {
    throw new Error('useToast must be used within a SonnerOrganism (ToastProvider)');
  }
  return context;
};
 ...
 * ```
 */
export const SonnerOrganism = React.forwardRef<HTMLDivElement, SonnerOrganismProps>(
  (
    {
      children,
      maxToasts = 5,
 ...
 * @example
 * ```tsx
 * import { toast } from '@/components/atomic-design/organisms/sonner';
 *
