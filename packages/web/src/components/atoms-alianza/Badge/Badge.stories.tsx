...
export const WithIcons: Story = {
  render: () => (
    <div className="flex flex-wrap gap-3">
      ...
      <Badge icon={<Info />} variant="outline">
        Info
      </Badge>
      <Badge icon={<Zap />} variant="warning">
        Fast
      </Badge>
      <Badge icon={<Heart />} variant="destructive">
        Favorite
      </Badge>
    </div>
  ),
    ...
    <div className="space-y-4 max-w-md">
      <div className="p-4 border rounded-lg">
        ...
        <div className="flex gap-2 mt-2">
          <Badge variant="primary" size="sm" icon={<Star />}>
            Best Seller
          </Badge>
      ...
      <div className="p-4 border rounded-lg">
        ...
        <div className="flex gap-2 mt-2">
          <Badge variant="outline" size="sm" icon={<TrendingUp />}>
            Popular
          </Badge>
        </div>
      </div>
    ...
    <div className="space-y-4">
      ...
      <div>
        <h4 className="text-sm font-medium mb-2">
          Removable with keyboard support
        </h4>
...
export const MigrationGuide: Story = {
  render: () => (
    <div className="space-y-6 max-w-2xl">
      ...
      <div>
        <h3 className="text-lg font-semibold mb-3">
          Migration from Theme Editor Badge
        </h3>
        <div className="space-y-2">
          <div className="p-3 bg-muted rounded">
