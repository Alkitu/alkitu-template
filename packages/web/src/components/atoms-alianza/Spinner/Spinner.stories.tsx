...
export const DotsSpinner: Story = {
  render: () => (
    <div className="flex flex-wrap gap-6 p-4">
      {(['primary', 'secondary', 'success', 'destructive'] as const).map(
        (variant) => (
...
export const PulseSpinner: Story = {
  render: () => (
    <div className="flex flex-wrap gap-6 p-4">
      {(['primary', 'secondary', 'warning', 'success'] as const).map(
        (variant) => (
          <div key={variant} className="flex flex-col items-center gap-2">
    ...
    <div className="flex flex-col gap-8 p-8">
      <div>
        ...
        <div className="flex flex-wrap gap-6">
          {(['primary', 'secondary', 'destructive', 'success'] as const).map(
            (variant) => (
              <Spinner
                key={variant}
                type="circular"
