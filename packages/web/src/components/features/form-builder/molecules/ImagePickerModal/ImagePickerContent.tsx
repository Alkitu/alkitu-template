...
import type { ImagePickerContentProps } from './ImagePickerModal.types';
 ...
 *
 * Extracted from ImagePickerModal so it can be reused in different contexts
 * (e.g. inside a modal, or embedded in the IconSelector's Pictures tab).
 */
export function ImagePickerContent({
  ...
  const handleFileProcess = useCallback(
    ...
    [onImageUpload, isDriveConfigured, uploadToDrive, onImageSelected, onDismiss],
  );
  ...
  }, [urlInput, urlPreviewLoaded, urlPreviewError, onImageSelected, onDismiss]);
