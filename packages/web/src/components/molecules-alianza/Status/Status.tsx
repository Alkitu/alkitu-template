...
import type { StatusProps, StatusVariant } from './Status.types';

/**
 * Status - Atomic Design Molecule
 *
 ...
 * @example
 * ```tsx
 * // Default variant with star icon
 * <Status label="Active" variant="default" />
 *
 * // Highlighted variant with warning colors
 * <Status label="Important" variant="highlighted" />
 *
 * // Radio button style
 * <Status label="Selected" variant="radio" />
 *
 * // Checkbox style
 * <Status label="Completed" variant="checkbox" />
 *
 * // Toggle switch style
 * <Status label="Enabled" variant="toggle" />
 * ```
 */
    ...
    const renderIcon = () => {
      switch (variant) {
        case 'default':
          return (
            <div
              className="relative shrink-0 size-[var(--icon-size-md)] flex items-center justify-center"
              data-testid="status-icon-default"
            >
              <svg
        ...
        case 'highlighted':
          return (
            <div
              className="relative shrink-0 size-[var(--icon-size-md)] flex items-center justify-center"
              data-testid="status-icon-highlighted"
            >
              <svg
                viewBox="0 0 11.33 10.86"
        ...
        case 'radio':
          return (
            <div
              className="size-[var(--icon-size-md)] rounded-full border border-accent-a bg-white flex items-center justify-center p-[var(--space-1)]"
              data-testid="status-icon-radio"
            >
        ...
        case 'checkbox':
          return (
            <div
              className="size-[var(--icon-size-md)] rounded-[var(--radius-xs)] bg-accent-a flex items-center justify-center"
              data-testid="status-icon-checkbox"
            >
              <svg
        ...
        case 'toggle':
          return (
            <div
              className="w-[var(--size-toggle-width)] h-[var(--size-toggle-height)] bg-accent-a rounded-[var(--radius-pill)] relative flex items-center justify-end px-[var(--space-1)]"
              data-testid="status-icon-toggle"
            >
