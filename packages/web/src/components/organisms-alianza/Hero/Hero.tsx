...
import { Badge } from '../../atoms-alianza/Badge';
import { Icon } from '../../atoms-alianza/Icon';
import { Typography } from '../../atoms-alianza/Typography';
import { Button } from '../../molecules-alianza/Button';
        ...
        <div className="aspect-video bg-gradient-to-br from-primary/20 to-secondary/20 rounded-lg flex items-center justify-center">
          <div className="text-center">
            <div className="h-16 w-16 mx-auto mb-4 bg-primary/10 rounded-full flex items-center justify-center">
              <Icon name="code" size="lg" aria-hidden />
            </div>
                ...
                <div className="flex flex-wrap items-center gap-4 pt-4">
                  {features.map((feature, index) => (
                    <div key={index} className="flex items-center gap-2">
                      <Icon
                        name={(feature.icon || 'checkCircle') as any}
                        size="sm"
