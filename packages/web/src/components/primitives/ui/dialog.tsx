...
/**
 * Dialog Component - Theme-Aware Implementation
 *
 * Uses comprehensive CSS variable system for dynamic theming:
 * - Border Radius: --radius-dialog
 * - Shadows: --shadow-dialog
...
function DialogContent({
  ...
  const contentStyles: React.CSSProperties = {
    // Border radius - Use dialog-specific radius
    borderRadius: 'var(--radius-dialog, calc(var(--radius, 0.375rem) + 8px))',

    // Shadow - Use dialog shadow for prominent elevation
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] border duration-200 sm:max-w-lg",
          className,
        )}
        {...props}
      >
